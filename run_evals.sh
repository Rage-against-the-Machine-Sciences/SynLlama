...
run_pipeline() {
  local MODEL="$1"
  local RUN_NAME="$2"
  local SKIP_INFERENCE="${3:-false}"

  local RUN_DIR="${SCRIPT_DIR}/../evals/synllama/results/sequential_medium_only/${RUN_NAME}"
...
FT_MODEL="${SCRIPT_DIR}/../ft_data/merged_synllama_r4_qv"

# run_pipeline "${BASE_MODEL}" "synllama_1b_2m_base_on_1k_enamine_synformer"
run_pipeline "${FT_MODEL}"   "synllama_1b_2m_merged_lr5e5_on_1k_enamine_synformer"
